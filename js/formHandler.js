			...
			if(!$form.attr('action')) // Check form doesnt have action attribute
			{
				...
				$.ajax({
		    		...
		    		success: function() // Success
		 			{  
						if($form.is('[data-success-message]')) // Show Success Message
						{
			   		...
			   		error: function() // Fail
			   		{
						...
						{
							$form.append("<div id='form-alert'><div class='alert alert-danger'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><strong>"+$form.attr('data-fail-message')+"</strong></div></div>");
						}	
			   		},
		   		});
			}
